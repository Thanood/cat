...
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 40, 0, 'FreeTechs'                   , 'cepObjectInfo.FreeTechs');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 41, 0, 'FreePolicies'                , 'cepObjectInfo.FreePolicies');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 42, 0, 'MinorFriendshipChange'       , 'cepObjectInfo.MinorFriendshipChange');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 43, 0, 'MinorFriendshipFlatChange'   , 'cepObjectInfo.MinorFriendshipFlatChange');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 44, 0, 'VictoryPoints'               , 'cepObjectInfo.VictoryPoints');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 45, 0, 'BorderObstacle'              , 'cepObjectInfo.BorderObstacle');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 46, 0, 'PlayerBorderObstacle'        , 'cepObjectInfo.PlayerBorderObstacle');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 47, 0, 'HealRateChange'              , 'cepObjectInfo.HealRateChange');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 48, 0, 'MountainImprovement'         , 'cepObjectInfo.MountainImprovement and Locale.ConvertTextKey(GameInfo.Improvements[cepObjectInfo.MountainImprovement].Description) or false');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 49, 0, 'FreePromotion'               , 'cepObjectInfo.FreePromotion and Locale.ConvertTextKey(GameInfo.UnitPromotions[cepObjectInfo.FreePromotion].Help) or false');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 50, 0, 'FreePromotionAllCombatUnits' , 'cepObjectInfo.FreePromotionAllCombatUnits and Locale.ConvertTextKey(GameInfo.UnitPromotions[cepObjectInfo.FreePromotionAllCombatUnits].Help) or false');

INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 51, 0, 'TradeDealModifier'           , 'cepObjectInfo.TradeDealModifier');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 52, 0, 'GlobalGreatPeopleRateModifier'      , 'cepObjectInfo.GlobalGreatPeopleRateModifier');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 53, 1, 'UnmoddedHappiness'           , 'Game.GetDefaultBuildingStatText');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 54, 1, 'Happiness'                   , 'Game.GetDefaultBuildingStatText');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 55, 0, 'HappinessPerCity'            , 'cepObjectInfo.HappinessPerCity');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 56, 0, 'HappinessPerXPolicies'       , 'cepObjectInfo.HappinessPerXPolicies');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 57, 0, 'UnhappinessModifier'         , 'cepObjectInfo.UnhappinessModifier');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 58, 0, 'NoOccupiedUnhappiness'       , 'cepObjectInfo.NoOccupiedUnhappiness');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 59, 0, 'InstantHappiness'            , 'cepObjectInfo.InstantHappiness');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 60, 0, 'GoldenAgePoints'             , 'cepObjectInfo.GoldenAgePoints');
...
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 68, 0, 'ExtraCityHitPoints'          , 'cepObjectInfo.ExtraCityHitPoints');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 69, 0, 'AirModifier'                 , 'cepObjectInfo.AirModifier');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 70, 0, 'NukeModifier'                , 'cepObjectInfo.NukeModifier');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 71, 0, 'YieldModInAllCities'         , 'Game.HasValue({BuildingType=cepObjectInfo.Type}, GameInfo.Building_GlobalYieldModifiers)');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 72, 0, 'YieldFromUsingGreatPeople'   , 'cepObjectInfo.GreatPersonExpendGold');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 73, 0, 'YieldModHurry'               , 'Game.HasValue({BuildingType=cepObjectInfo.Type}, GameInfo.Building_HurryModifiers)');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 74, 0, 'CityConnectionTradeRouteModifier'   , 'cepObjectInfo.CityConnectionTradeRouteModifier');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 75, 0, 'MedianTechPercentChange'     , 'cepObjectInfo.MedianTechPercentChange * 2');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 76, 0, 'InstantBorderRadius'         , 'cepObjectInfo.InstantBorderRadius');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 77, 0, 'InstantBorderPlots'          , 'Game.HasValue({BuildingType=cepObjectInfo.Type}, GameInfo.Building_PlotsYieldChanges)');
INSERT INTO BuildingStats(Section, Priority, Dynamic, Type, Value) VALUES (1, 78, 0, 'ReligiousPressureModifier'   , 'cepObjectInfo.ReligiousPressureModifier');
